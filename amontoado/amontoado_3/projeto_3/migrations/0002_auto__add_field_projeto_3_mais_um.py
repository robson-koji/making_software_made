...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'projeto_3.mais_um'
        db.add_column(u'projeto_3_projeto_3', 'mais_um',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'projeto_3.mais_um'
        db.delete_column(u'projeto_3_projeto_3', 'mais_um')
    ...
    models = {
        ...
        u'projeto_3.projeto_3': {
            ...
            'mais_um': ('django.db.models.fields.CharField', [], {'max_length': '100'}),

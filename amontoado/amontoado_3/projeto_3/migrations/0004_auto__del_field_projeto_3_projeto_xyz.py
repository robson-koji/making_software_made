...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'projeto_3.projeto_xyz'
        db.delete_column(u'projeto_3_projeto_3', 'projeto_xyz')


    def backwards(self, orm):
        # Adding field 'projeto_3.projeto_xyz'
        db.add_column(u'projeto_3_projeto_3', 'projeto_xyz',

...
class CreateView( UpdateContextMixin,  generic.CreateView ):
...
class DetailView( generic.DetailView ):
    ...
    def get_context_data(self, **kwargs):
        ...
        reverso_clone = self.kwargs['reverso_clone']

        context = super(DetailView, self).get_context_data(**kwargs)
        context.update({
            'reverso_update': reverso_update, 'reverso_delete': reverso_delete, 'reverso_list': reverso_list, 'reverso_clone': reverso_clone
        })
        return context

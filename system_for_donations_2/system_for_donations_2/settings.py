...
#SESSION_COOKIE_PATH = '/system_for_donations_2'
LOGIN_REDIRECT_URL = '/system_for_donations_2/flat/fb_app/instrucoes/'
LOGIN_URL = '/system_for_donations_2/accounts/login/'
LOGOUT_URL = '/system_for_donations_2/accounts/logout/'
MEDIA_ROOT = '/home/making_software/projetos/making_software_made/system_for_donations_2/media/'
MEDIA_URL = '/system_for_donations_2/media/'
URL_ROOT = '/system_for_donations_2/'
ADMINS = ()
# allauth
...
STATICFILES_DIRS = (
    '//home/making_software/projetos/making_software_made/system_for_donations_2/static_files',
)
SECRET_KEY = '=remywy=8s2jmdj*a*d)d!%tu3w7&#!j+6ku^72lc0mz_1l1ag'
ROOT_URLCONF = 'system_for_donations_2.urls'
WSGI_APPLICATION = 'system_for_donations_2.wsgi.application'
TEMPLATE_DIRS = (
    '/home/making_software/projetos/making_software_made/system_for_donations_2/templates/'
)
INSTALLED_APPS = (
    'django.contrib.auth',
